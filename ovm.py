...
repo_id = get_id_from_name(s,baseUri,'Repository','OVM69_REPO')
sp_id= get_id_from_name(s,baseUri,'ServerPool','OVM69_POOL')
data= {'name':'autocore1','description':'VM created using REST API','vmDomainType':'XEN_PVM','repositoryId':repo_id,'serverPoolId':sp_id}
...
vm_info =get_id_from_name(s,baseUri,'Vm','autocore1')
